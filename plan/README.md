...
| 6 | STOMP 1.2 support, B1 fix, 1.1 follow-ups ([1.1 check](stomp-1.1-compliance.md), [1.2 check](stomp-1.2-compliance.md#proposed-step-6-stomp-12)) | 2.0.0 | M | planned |
