...
* 0.1.4 Binary data sending, updated documentation, allowed server name modification.
...
| [serverName] | <code>string</code> | <code>&quot;STOMP-JS/0.1.4&quot;</code> | Websocket server name |
